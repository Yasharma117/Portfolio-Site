...
import recipeDetailsImage from '../assets/recipe-img.png'; 

export default function RecipeDetails() {
  return (
    <section className="min-h-screen w-full bg-gradient-to-r from-[#f9f7f4] to-[#f3efea]  px-6 md:px-16 lg:px-24 overflow-hidden">
      <div className="relative mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-x-12 items-center">
        ...
        style={{ fontFamily: 'var(--font-aeonik)' }}>
          ...
          <p className="text-lg md:text-xl text-[#333] max-w-md">
